...
export class OpenRouterHandler implements ApiHandler {
	...
	constructor(options: ApiHandlerOptions) {
		...
		this.client = new OpenAI({
			...
			defaultHeaders: {
				"HTTP-Referer": "https://goodloops.dev", // Optional, for including your app on openrouter.ai rankings.
				"X-Title": "Goodloops Dev", // Optional. Shows in rankings on openrouter.ai.
			},
		})
	}
